 ...
 * @version $Id: $
 */
public class RemoveUsersFromCMJob extends AbstractQuartzJobImpl {
	...
	private static Log log = LogFactory
			.getLog(RemoveUsersFromCMJob.class);
	...
	private void loadConfigFile(){
		...
		String fileName = "/content/group/opensyllabusAdmin/config/removeUsersFromCMConfig.xml";
