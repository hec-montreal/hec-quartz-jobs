...
* @version $Id: $
*/
public class RemoveUsersFromSiteJob extends AbstractQuartzJobImpl {
    ...
    private static Log log = LogFactory
	    .getLog(RemoveUsersFromSiteJob.class);
	...
	String fileName = "/content/group/opensyllabusAdmin/config/removeUsersFromSitesConfig.xml";
