...
import ca.hec.sakai.jobs.api.ConfigurationService;
import ca.hec.sakai.jobs.api.CourseEventSynchroJob;
import ca.hec.sakai.jobs.api.CourseManagementSyncJob;
...
import ca.hec.sakai.extracts.*;
import ca.hec.sakai.jobs.api.OfficialSitesJob;
import java.io.File;
...
/**
 * The class is an implementation of the CourseManagementSyncJob as job launched by the quartz
 *
 * @author <a href="mailto:mame-awa.diop@hec.ca">Mame Awa Diop</a>, <a href="mailto:curtis.van-osch@hec.ca">Curtis van Osch</a>
 * @version $Id: $
 */

public class CourseManagementSyncJobImpl extends AbstractHecQuartzJobImpl implements CourseManagementSyncJob {
     ...
     * Our logger
     */
    private static Log log = LogFactory.getLog(CourseManagementSyncJobImpl.class);
...
//                        }
    ...
    private String getSessionName(AcademicSession session) {
        ...
        if ((sessionId.charAt(3)) == '1')
            sessionName = OfficialSitesJob.WINTER + year;
        if ((sessionId.charAt(3)) == '2')
            sessionName = OfficialSitesJob.SUMMER + year;
        if ((sessionId.charAt(3)) == '3')
            sessionName = OfficialSitesJob.FALL + year;
